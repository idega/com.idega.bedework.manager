...
public class SysparsFieldRule extends EntityFieldRule {
  ...
  public void field(String name) throws Exception {
    ...
    if (name.equals("name")) {
      ...
      ent.setHttpConnectionsPerUser(parval(syspars.getHttpConnectionsPerUser(),
                                           intFld()));
    } else if (name.equals("httpConnectionsPerHost")) {
      ent.setHttpConnectionsPerHost(parval(syspars.getHttpConnectionsPerHost(),
                                           intFld()));
    } else if (name.equals("httpConnections")) {
      ent.setHttpConnections(parval(syspars.getHttpConnections(),
                                    intFld()));
