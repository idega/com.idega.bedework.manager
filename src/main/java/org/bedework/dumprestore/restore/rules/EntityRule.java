...
public class EntityRule extends RestoreRule implements Defs {
  ...
  static {
    classes.put("sponsor", BwContact.class.getName());              // PRE3.3
    classes.put(objectUserPrefs, BwPreferences.class.getName());    // PRE3.5
    ...
    classes.put(objectTimeZone, SkipThis.class.getName());           // PRE3.5
    ...
    classes.put(objectOrganizer, OrganizerEntity.class.getName());
