...
public class AdminGroupFieldRule extends EntityFieldRule {
  ...
  AdminGroupFieldRule(RestoreGlobals globals) {
    super(globals);
  }
  ...
  public void field(String name) throws Exception {
    ...
    } else if (name.equals("groupOwner")) {    // PRE3.3
      ag.setGroupOwnerHref(userFld().getPrincipalRef());
    } else if (name.equals("ownerid")) {      // PRE3.3
      ag.setOwnerHref(userFld().getPrincipalRef());
