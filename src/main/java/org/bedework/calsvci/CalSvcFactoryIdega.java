...
public class CalSvcFactoryIdega implements CalSvcFactory {
	...
	public CalSvcI getSvc(CalSvcIPars pars) throws CalFacadeException {
		try {
			...
			Class<?> cl = loader.loadClass(BedeworkManagerConstants.CLASS_IDEGA_SVCI);

			if (cl == null) {
				throw new CalFacadeException("Class "
						+ BedeworkManagerConstants.CLASS_IDEGA_SVCI + " not found");
			}
			...
			if (o == null) {
				throw new CalFacadeException("Unable to instantiate class "
						+ BedeworkManagerConstants.CLASS_IDEGA_SVCI);
			}

			if (!(o instanceof CalSvc)) {
				throw new CalFacadeException("Class "
						+ BedeworkManagerConstants.CLASS_IDEGA_SVCI
						+ " is not a subclass of " + CalSvc.class.getName());
			}
